    ...
    fCreateRequisition: function(that, action) {
      ...
      onBeforeUpload: function(oEvent) {
        ...
        if(this.settingStatus){
          dados = "BENEFICIOS;BIE;" + req + ";STATUS;" + conta_anexos + ";S;" + pernr;
        }else{
          //FILENAME; DMS TYPE; REQUISITION; OPERATION TYPE; CHARACTERISTIC, STATUS, PERNR 
          dados = filename + ";BIE;" + req + ";INSERT;" + caracteristica + ";S" + ";" + pernr;
        }
        ...
        onUploadAttComplete: function(oEvent) {
          if (oEvent.mParameters.getParameter('status') !== 201) {
        ...
        isValidNumber: function(id) {
          ...
          const translatedValue = value.replace(",",".");
          return !(isNaN(translatedValue));
        }
      })
    });