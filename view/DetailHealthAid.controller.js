sap.ui.define([
  ...
  return BaseController.extend("cadastralMaintenance.view.DetailHealthAid", {
    ...
    fGetBlock: function () {
      ...
      //MAIN READ
      oModel.read("ET_HEALTH_AID" + urlParam, null, null, false, fSuccess, fError);
    },
    ...
    fCreateRequisition: function (that, action) {
      ...
      function fSuccess(oEvent) {
        ...
        var oModel = new sap.ui.model.odata.ODataModel("/sap/opu/odata/sap/ZODHR_SS_MAINTENANCE_CADASTRAL_SRV/");
        oModel.create("ET_HEALTH_AID", oCreate, null, fSuccess, fError);
      },
      ...
      onBeforeUpload: function (oEvent) {
        ...
        if(this.settingStatus){
          dados = "BENEFICIOS;BSS;" + req + ";STATUS;" + conta_anexos + ";S;" + pernr;
        }else{
          // FILENAME; DMS TYPE; REQUISITION; OPERATION TYPE; CHARACTERISTIC, STATUS, PERNR
          dados = filename + ";BSS;" + req + ";INSERT;" + caracteristica + ";S" + ";" + pernr;
        }
